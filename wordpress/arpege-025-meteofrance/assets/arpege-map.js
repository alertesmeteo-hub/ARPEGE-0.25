(function () {
    ...
    function initMap(app) {
        ...
        var menuToggle = app.querySelector('[data-arp025m-menu-toggle]');
        var menuClose = app.querySelector('[data-arp025m-menu-close]');
        var layerMenu = app.querySelector('[data-arp025m-layer-menu]');
        var layerGrid = app.querySelector('[data-arp025m-layer-grid]');
        var currentLayerText = app.querySelector('[data-arp025m-current-layer]');
        var previousButton = app.querySelector('[data-arp025m-previous]');
        var playButton = app.querySelector('[data-arp025m-play]');
        var nextButton = app.querySelector('[data-arp025m-next]');
        var validity = app.querySelector('[data-arp025m-validity]');
        var lead = app.querySelector('[data-arp025m-lead]');
        var run = app.querySelector('[data-arp025m-run]');
        var generated = app.querySelector('[data-arp025m-generated]');
        var stale = app.querySelector('[data-arp025m-stale]');
        var viewport = app.querySelector('[data-arp025m-viewport]');
        var weatherCanvas = app.querySelector('[data-arp025m-weather]');
        var vectorCanvas = app.querySelector('[data-arp025m-vectors]');
        var labelsCanvas = app.querySelector('[data-arp025m-labels]');
        ...
        var mapTitle = app.querySelector('[data-arp025m-map-title]');
        var mapRun = app.querySelector('[data-arp025m-map-run]');
        var mapDate = app.querySelector('[data-arp025m-map-date]');
        var loading = app.querySelector('[data-arp025m-loading]');
        var errorBox = app.querySelector('[data-arp025m-error]');
        var slider = app.querySelector('[data-arp025m-slider]');
        var timeline = app.querySelector('[data-arp025m-timeline], .arp025m-timeline');
        var periodSelector = app.querySelector('[data-arp025m-period]');
        var dualRange = app.querySelector('[data-arp025m-dual-range]');
        var periodStartSlider = app.querySelector('[data-arp025m-period-start]');
        var periodEndSlider = app.querySelector('[data-arp025m-period-end]');
        var periodTitle = app.querySelector('[data-arp025m-period-title]');
        var periodSummary = app.querySelector('[data-arp025m-period-summary]');
        var periodStartLabel = app.querySelector('[data-arp025m-period-start-label]');
        var periodEndLabel = app.querySelector('[data-arp025m-period-end-label]');
        var legend = app.querySelector('[data-arp025m-legend]');
        var zoomIn = app.querySelector('[data-arp025m-zoom-in]');
        var zoomOut = app.querySelector('[data-arp025m-zoom-out]');
        var reset = app.querySelector('[data-arp025m-reset]');
        var fullscreen = app.querySelector('[data-arp025m-fullscreen]');
        var zoomLevel = app.querySelector('[data-arp025m-zoom-level]');
        var probe = app.querySelector('[data-arp025m-probe]');
        var probeValue = app.querySelector('[data-arp025m-probe-value]');
        var probeLabel = app.querySelector('[data-arp025m-probe-label]');
        var toolButtons = app.querySelectorAll('[data-arp025m-tool]');
        var toolHint = app.querySelector('[data-arp025m-tool-hint]');
        var advancedTools = app.querySelector('[data-arp025m-advanced-tools]');
        var captureButton = app.querySelector('[data-arp025m-capture]');
        var pinButton = app.querySelector('[data-arp025m-pin]');
        var diagramPopup = app.querySelector('[data-arp025m-diagram-popup]');
        var diagramTitle = app.querySelector('[data-arp025m-diagram-title]');
        var diagramBody = app.querySelector('[data-arp025m-diagram-body]');
        var diagramStatus = app.querySelector('[data-arp025m-diagram-status]');
        var diagramClose = app.querySelector('[data-arp025m-diagram-close]');
        ...
        function pinProbeAt(clientX, clientY) {
            ...
            pinnedElement.className = 'arp025m-probe arp025m-probe-pinned';
            ...
            close.type = 'button';
            close.className = 'arp025m-probe-pin-close';
        ...
        function setToolMode(mode) {
            ...
            toolButtons.forEach(function (button) {
                var active = button.dataset.arp025mTool === toolMode;
        ...
        function renderDiagramChart(name, forecastRows, columnIndex, pointIndex) {
            ...
            svg.setAttribute('class', 'arp025m-diagram-svg');
            ...
            rains.forEach(function (value, index) {
                ...
                rect.setAttribute('class', 'arp025m-diagram-rain');
            ...
            if (points.length > 1) {
                ...
                polyline.setAttribute('class', 'arp025m-diagram-temp');
            ...
            [0, count - 1].forEach(function (index) {
                ...
                text.setAttribute('class', 'arp025m-diagram-axis');
            ...
            caption.className = 'arp025m-diagram-caption';
        ...
        function applyMapAspectRatio(bounds) {
            ...
            viewport.style.setProperty('--arp025m-map-ratio', String(ratio));
        }
        ...
        function refreshLayerMenu() {
            ...
            layerGrid.querySelectorAll('[data-arp025m-layer-key]').forEach(function (button) {
                var active = button.dataset.arp025mLayerKey === currentLayer;
                button.classList.toggle('is-active', active);
                button.setAttribute('aria-pressed', active ? 'true' : 'false');
            });
        }
        ...
        function buildLayerMenu() {
            ...
            var columns = [0, 1, 2].map(function () {
                ...
                column.className = 'arp025m-layer-column';
            ...
            groupOrder.forEach(function (group) {
                ...
                section.className = 'arp025m-layer-group';
                ...
                grouped[group].forEach(function (entry) {
                    ...
                    button.type = 'button';
                    button.className = 'arp025m-layer-option' +
                        (essential ? '' : ' arp025m-layer-option-secondary');
                    if (!essential) {
                        button.hidden = !showSecondaryLayers;
                    }
                    button.dataset.arp025mLayerKey = entry.key;
            ...
            if (hasSecondary) {
                ...
                moreButton.className = 'arp025m-layer-more';
                moreButton.dataset.arp025mLayerMore = '1';
        ...
        function buildLegend() {
            ...
            strip.className = 'arp025m-legend-strip';
            layer.stops.forEach(function (stop) {
                var item = document.createElement('div');
                item.className = 'arp025m-legend-stop';
        ...
        function updatePeriodControls() {
            ...
            if (dualRange && dualRange.style && dualRange.style.setProperty) {
                ...
                dualRange.style.setProperty(
                    '--arp025m-period-start', (periodStart / maximum * 100) + '%'
                );
                dualRange.style.setProperty(
                    '--arp025m-period-end', (periodEnd / maximum * 100) + '%'
                );
            }
        }
        ...
        app.addEventListener('arp025m:focus-location', function (event) {
        ...
        toolButtons.forEach(function (button) {
            button.addEventListener('click', function () {
                setToolMode(button.dataset.arp025mTool);
            });
        });
        if (captureButton) {
        ...
        viewport.addEventListener('pointerdown', function (event) {
            if (event.target.closest('button, .arp025m-diagram-popup, .arp025m-probe-pinned')) {
                return;
            }
            hideProbe();
            tapStart = {
    ...
    whenReady(function () {
        document.querySelectorAll('[data-arp025m-app]').forEach(initMap);
    });
}());
